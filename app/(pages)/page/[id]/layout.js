                ...
                <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    ...
                    <nav>
                        <ul className="flex space-x-6">
                            ...
                            <li><a href="/discover" className="hover:text-blue-600 transition-colors">Discover</a></li>
                            <li><a href="/page" className="hover:text-blue-600 transition-colors">Pages</a></li>
                        </ul>
                    </nav>
                </div>
            </header>
